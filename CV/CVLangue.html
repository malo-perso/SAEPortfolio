...
<body style="border-color: var(--color-brown);">
        ...
        <ul class="nav nav-tabs flex-column" style="border-style: none;">
            ...
            <li class="nav-item"><a class="nav-link active" href="#" style="color: var(--bs-body-color);background: #c8b79c;border-color: var(--bs-body-bg);border-left: px solid var(--color-blue);">CV</a>
                <ul class="nav nav-tabs" style="border-style: none;">
                    ...
                    <li class="nav-item"><a class="nav-link" style="color: var(--bs-body-color);background: #e7e4df;width: 150px;">Expériences</a></li>
                    <li class="nav-item"><a class="nav-link" href="#" style="color: var(--bs-body-color);width: 150px;background: #e7e4df;">Compétences</a></li>
                    <li class="nav-item"><a class="nav-link active" href="#" style="color: var(--bs-body-color);width: 150px;background: #c8b79c;">Langues</a></li>
                </ul>
            </li>
    ...
    <button class="btn btn-primary" data-bss-hover-animate="pulse" type="button" style="margin-left: 189px;border-style: solid;border-color: var(--color-brown);background: rgba(255,255,255,0.5);color: var(--color-brown);margin-top: 45px;"><a href="CVCompetence.html" style="color: var(--color-brown)">Précédent (compétences)</a></button>
