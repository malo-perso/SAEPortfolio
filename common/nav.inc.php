...
function getNav($pageEnCours)
{
    ...
    $array      = array("accueil.php"   , "CVResume.php", "CVCoordonnees.php"   , "CVFormation.php" , "CVExperience.php", "CVCompetence.php", "CVLangue.php", "Compétences.php" , "Projet.php"  , "Contact.php");
    ...
    for ($i = 0; $i < count($array); $i++) 
    {
        ...
        else
        {
            ...
            if ($array[$i] == $pageEnCours)
            {
                echo "<li class=\"nav-item\"><a class=\"nav-link active\" href=\"../CV/$array[$i]\" style=\"color: var(--bs-body-color);background: #c8b79c;border-color: var(--bs-body-bg);border-left: px solid var(--color-blue);\">$arrayNom[$i]</a></li>\n";
            }
            else
            {
                echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"../CV/$array[$i]\" style=\"color: var(--bs-body-color);\">$arrayNom[$i]</a></li>\n";
            }
        }
    }
